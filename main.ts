...
(async () => {
    ...
    const raiseHandButton = await page.waitForSelector('#yDmH0d > c-wiz > div > div > div:nth-child(24) > div.crqnQb > div.fJsklc.nulMpf.Didmac.G03iKb > div > div > div.Tmb7Fd > div > div:nth-child(6) > div > div.p2SYhf > span > button')
